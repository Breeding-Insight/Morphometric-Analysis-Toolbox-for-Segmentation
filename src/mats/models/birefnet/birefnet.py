"""Pinned BiRefNet architecture bundled for offline MATS inference.

Vendored without functional changes from ZhengPeng7/BiRefNet Hugging Face
snapshot e2bf8e4460fc8fa32bba5ea4d94b3233d367b0e4.  See ``LICENSE`` in this
directory for the upstream MIT license.
"""
